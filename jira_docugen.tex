...
the browser window.~
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 7 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            ALTERNATIVE: DO THE QUERY/SAVE WITHIN THE PORTAL ASPECT:
...
step and the previous one should be updated as the system evolves.
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 9 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Execute an ADQL query using the TAP service.
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1207}{LVV-T1207}
    - Execute a simple ADQL query via the TAP service
}\label{lvv-t1207}
