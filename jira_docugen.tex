...
% using template at /Library/Frameworks/Python.framework/Versions/3.10/lib/python3.10/site-packages/docsteady-2.2.9.post4+g0778ddd.d20220916-py3.10.egg/docsteady/templates/spec.latex.jinja2.
...
âž¡ \url{https://data.lsst.cloud/api/tap}\\[2\baselineskip]Example
screen output from CELL 2 (may not contain the same 10
...
postageStampRetrievalTime = 10sec.Â~
...
maximum spcification of diaNearbyObjRadius = 6 arcsec.Â~
...
archived inputs and provenance data.Â~
...
Verufy that the Science Data Archive Â~contains all necessary
engineering and calibration data for the full understanding of the
performance and operation of the Observatory.
...
and temporal correlations can Â~be answered in less than
