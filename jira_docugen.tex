...
Software
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T151}{Verify Implementation of Catalog Export Formats From the Notebook Aspect
} \tabularnewline
...
Availability
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T181}{Verify integration of Summit Facility Data Communications
} \tabularnewline
...
processing
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1097}{Verify Summit to Base Network Implementation
} \tabularnewline
    \hyperref[lvv-t1168]{LVV-T1168} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1168}{Test Summit - Base Network Integration
} \tabularnewline
    \hyperref[lvv-t1232]{LVV-T1232} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1232}{Verify Implementation of Catalog Export Formats From the Portal Aspect
} \tabularnewline
    \hyperref[lvv-t1240]{LVV-T1240} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1240}{Verify implementation of minimum astrometric standards per CCD
} \tabularnewline
...
users
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1251}{Verify implementation of maximum time to retrieve DM EFD query results
} \tabularnewline
    \hyperref[lvv-t1252]{LVV-T1252} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1252}{Verify number of simultaneous alert filter users
} \tabularnewline
\bottomrule
\end{longtable}
...
'DATA/path', then execute the following:
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 2 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Ingest the data from the most recent reprocessing of HSC RC2 data
(identify the path to these data on the LSST Development Cluster at
\href{https://confluence.lsstcorp.org/display/DM/Reprocessing+of+the+HSC+RC2+dataset}{this
Confluence page}.
...
list to Gaia DR2, and calculate the positional offset between the HSC
...
\subsubsection{Test Procedure}
    ...
    \endhead
            ...
            \multirow{3}{*}{ 1 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Identify the location of a test dataset (for example, the HSC RC2 data
that are regularly reprocessed; identify the path to these data on the
LSST Development Cluster at
\href{https://confluence.lsstcorp.org/display/DM/Reprocessing+of+the+HSC+RC2+dataset}{this
Confluence page}).
...
the crosstalk correction matrix.
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 2 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Execute the relevant portion of the CPP (aka `cp\_pipe`), and confirm
that the crosstalk correction matrix is produced and persisted.
...
frames, and flat-field frames.
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 2 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Execute the CPP (aka `cp\_pipe`) on the data set.
...
\subsubsection{Test Procedure}
    ...
    \endhead
            ...
            \multirow{3}{*}{ 1 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Run the Alert Production pipeline on a data set such as the HiTS 2015
data used in `ap\_verify`.
...
for 100 simultaneously-operating brokers to receive up to 20 alerts per
visit.
...
\subsubsection{Test Procedure}
    ...
    \endhead
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 2 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Simultaneously execute user-defined alert filters for at least 100
users, and confirm that the system successfully filters the stream as
requested. Confirm that the bandwidth requirement was met.
...
algorithms, on a small portion of the data from the simulated Twinkles
dataset.
...
'DATA/path', then execute the following:
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 2 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Ingest the data products resulting from the "ci\_hsc" daily DRP
processing.
...
magnitudes to show that they are well-calibrated.{]}
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 4 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Ingest the data products resulting from the "ap\_verify" daily AP
processing.
...
\subsubsection{Test Procedure}
    ...
    \endhead
            ...
            \multirow{3}{*}{ 1 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Confirm that the CI jobs known as "ci\_hsc" (DRP processing on HSC data)
and "ap\_verify" (Alert Production processing on a small amount of HiTS
2015 DECam data) successfully run.~
...
\subsubsection{Test Procedure}
    ...
    \endhead
            ...
            \multirow{3}{*}{ 1 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Identify a test dataset (for example, the HSC RC2 data that are
regularly reprocessed; identify the path to these data on the LSST
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T151}{LVV-T151}
    - Verify Implementation of Catalog Export Formats From the Notebook Aspect
}\label{lvv-t151}
...
dat\_fits = Table.read('test.fits', format='fits')\\
~\\
import numpy as np\\
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T181}{LVV-T181}
    - Verify integration of Summit Facility Data Communications
}\label{lvv-t181}
...
\subsubsection{Test Items}
This verifies that the Summit Network is integrated properly with the
Summit - Base Network. ~(The former is a TS deliverable, the latter a DM
deliverable). ~Demonstrate data is transferred over the summit
instrument data fibers, from the DAQ to the Summit - Base DWDM, along
with monitoring network performance. ~This requirement does not include
testing the DAQ buffering of the data, nor the transfer from summit to
base which are covered elsewhere.
...
'DATA/path', then execute the following:
        ...
        \\ \midrule
            ...
            \begin{minipage}[t]{13cm}{\footnotesize
            Point the butler to a simulated dataset containing data in all filters,
that is sufficient for the purposes of measuring astrometric performance
metrics.
...
metrics.
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 4 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Compare measured astrometry to known values from input simulated data,
and confirm that the output values for all of the astrometric
performance metrics are as expected.
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1097}{LVV-T1097}
    - Verify Summit to Base Network Implementation
}\label{lvv-t1097}
...
\paragraph{Software}
OCS/DMCS test harness\\
Simulated images and meta-data\\
EFD\\
DAQ client\\
Archiver/forwarder (Data Backbone)


\paragraph{Hardware}
DAQ\\
Base servers with archiver
...
\item
  Simulated or real DAQ installed on summit and pre-loaded with image
  data.
\item
  EFD installed on summit and pre-loaded with image meta-data.
\item
  Archiver/forwarders installed in Base and operating properly.
\item
  OCS/DMCS test harness installed and pre-configured to trigger read-out
  and transfer.
\end{enumerate}


\subsubsection{Output Specification}
Image and meta-data transferred to Base Archiver/Forwarders.
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1168}{LVV-T1168}
    - Test Summit - Base Network Integration
}\label{lvv-t1168}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1232}{LVV-T1232}
    - Verify Implementation of Catalog Export Formats From the Portal Aspect
}\label{lvv-t1232}
...
the text in the ADQL Query box, then clicking "Search" at the lower left
corner of the page.
...
\item
  ...
  local computer.
\item
  Select "VOTable", then specify a destination to save the file on your
  local computer.
\item
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1240}{LVV-T1240}
    - Verify implementation of minimum astrometric standards per CCD
}\label{lvv-t1240}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1250}{LVV-T1250}
    - Verify implementation of minimum number of simultaneous DM EFD query
users
}\label{lvv-t1250}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1251}{LVV-T1251}
    - Verify implementation of maximum time to retrieve DM EFD query results
}\label{lvv-t1251}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1252}{LVV-T1252}
    - Verify number of simultaneous alert filter users
}\label{lvv-t1252}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T18}{LVV-T18}
    - AG-00-05: Alert Generation Produces Required Data Products
}\label{lvv-t18}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T216}{LVV-T216}
    - Installation of the Alert Distribution payloads.
}\label{lvv-t216}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T217}{LVV-T217}
    - Full Stream Alert Distribution
}\label{lvv-t217}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T987}{LVV-T987}
    - Instantiate the Butler for reading data
}\label{lvv-t987}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T21}{LVV-T21}
    - AG-00-20: Scientific Verification of DIASource Catalog
}\label{lvv-t21}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T22}{LVV-T22}
    - AG-00-25: Scientific Verification of DIAObject Catalog
}\label{lvv-t22}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T16}{LVV-T16}
    - DRP-00-35: Scientific Verification of Coadd Images
}\label{lvv-t16}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T13}{LVV-T13}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T14}{LVV-T14}
    - DRP-00-25: Scientific Verification of Object Catalog
}\label{lvv-t14}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T15}{LVV-T15}
    - DRP-00-30: Scientific Verification of Processed Visit Images
}\label{lvv-t15}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1207}{LVV-T1207}
    - Execute a simple ADQL query using the TAP service in the notebook aspect
}\label{lvv-t1207}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1208}{LVV-T1208}
    - Log out of the notebook aspect of the LSP
}\label{lvv-t1208}
