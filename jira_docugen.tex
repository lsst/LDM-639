...
% using template at /usr/share/miniconda/envs/docsteady-env/lib/python3.7/site-packages/docsteady/templates/spec.latex.jinja2.
...
Definition} &  Defined \tabularnewline
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T66}{Verify implementation of Forced-Source Catalog} &  Defined \tabularnewline
...
Re-Use} &  Defined \tabularnewline
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T136}{Verify implementation of Image Data Product Access} &  Defined \tabularnewline
...
cutouts} &  Defined \tabularnewline
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T38}{Verify implementation of Processed Visit Images} &  Approved \tabularnewline
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T42}{Verify implementation of Processed Visit Image Content} &  Approved \tabularnewline
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T74}{Verify implementation of Template Coadds} &  Approved \tabularnewline
    \hyperref[lvv-t77]{LVV-T77} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T77}{Verify implementation of Best Seeing Coadds} &  Approved \tabularnewline
    \hyperref[lvv-t78]{LVV-T78} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T78}{Verify implementation of Persisting Data Products} &  Approved \tabularnewline
    \hyperref[lvv-t84]{LVV-T84} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T84}{Verify implementation of Bias Residual Image} &  Approved \tabularnewline
    \hyperref[lvv-t90]{LVV-T90} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T90}{Verify implementation of Dark Current Correction Frame} &  Approved \tabularnewline
    \hyperref[lvv-t91]{LVV-T91} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T91}{Verify implementation of Fringe Correction Frame} &  Approved \tabularnewline
    \hyperref[lvv-t115]{LVV-T115} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T115}{Verify implementation of Calibration Production Processing} &  Approved \tabularnewline
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T126}{Verify implementation of Image Differencing} &  Approved \tabularnewline
    \hyperref[lvv-t127]{LVV-T127} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T127}{Verify implementation of Provide Source Detection Software} &  Approved \tabularnewline
    \hyperref[lvv-t129]{LVV-T129} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T129}{Verify implementation of Provide Calibrated Photometry} &  Approved \tabularnewline
...
Software} &  Approved \tabularnewline
    \hyperref[lvv-t137]{LVV-T137} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T137}{Verify implementation of Data Product Ingest} &  Approved \tabularnewline
...
Facility} &  Approved \tabularnewline
...
and Heterogeneity} &  Approved \tabularnewline
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1556}{LDM-503-10B Large Scale CCOB Data Access} &  Approved \tabularnewline
...
separations greater than or equal to 5 arcmin} &  Approved \tabularnewline
...
separations less than 1 arcmin} &  Approved \tabularnewline
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1758}{Verify that the repeatability outlier limit for isolated bright
non-saturated point sources in the u, z, and y filters (PA2uzy) can be
applied.} &  Approved \tabularnewline
    \hyperref[lvv-t1759]{LVV-T1759} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1759}{Verify that the repeatability outlier limit for isolated bright
non-saturated point sources in the g, r, and i filters (PA2gri) can be
applied.} &  Approved \tabularnewline
    \hyperref[lvv-t1830]{LVV-T1830} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1830}{Verify Implementation of Scientific Visualization of Camera Image Data} &  Approved \tabularnewline
    ...
    \hyperref[lvv-t2202]{LVV-T2202} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2202}{Verify that the of zero-point error outlier limit threshold (PA4) can be
applied.} &  Approved \tabularnewline
...
processing} &  Draft \tabularnewline
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2091}{Verify Fraction of Alerts Transmitted Within Latency Threshold} &  Draft \tabularnewline
    \hyperref[lvv-t2092]{LVV-T2092} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2092}{Verify Meeting Threshold for Max Fraction of Visits With Failed Alerts} &  Draft \tabularnewline
    \hyperref[lvv-t2093]{LVV-T2093} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2093}{Verify Latency of Reporting Transients} &  Draft \tabularnewline
    \hyperref[lvv-t2094]{LVV-T2094} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2094}{Verify Peak Number of Alerts Per Standard Visit} &  Draft \tabularnewline
    \hyperref[lvv-t2095]{LVV-T2095} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2095}{Verify Max Fraction of Visits With Alert Delays} &  Draft \tabularnewline
    \hyperref[lvv-t2096]{LVV-T2096} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2096}{Verify Handling of Peak Number of Alerts} &  Draft \tabularnewline
    \hyperref[lvv-t2097]{LVV-T2097} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2097}{Verify Handling of Average Number of Alerts} &  Draft \tabularnewline
    \hyperref[lvv-t2176]{LVV-T2176} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2176}{Per-image limit on the median residual ellipticity correlations at
scales greater than or equal to 5 arcmin.} &  Draft \tabularnewline
    \hyperref[lvv-t2177]{LVV-T2177} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2177}{Per-image limit on the median residual ellipticity correlations at
scales less than to 5 arcmin.} &  Draft \tabularnewline
    \hyperref[lvv-t2297]{LVV-T2297} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2297}{Verify implementation of Science Data Archive} &  Draft \tabularnewline
    \hyperref[lvv-t2302]{LVV-T2302} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2302}{Verify the minimum number of simultaneous users retrieving a set of
postage stamp images} &  Draft \tabularnewline
    \hyperref[lvv-t2303]{LVV-T2303} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2303}{Verify Image Archive} &  Draft \tabularnewline
    \hyperref[lvv-t2304]{LVV-T2304} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2304}{Verify maximum number of stars associated with a DIASource.} &  Draft \tabularnewline
    \hyperref[lvv-t2305]{LVV-T2305} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2305}{Verify radius considered nearby} &  Draft \tabularnewline
    \hyperref[lvv-t2328]{LVV-T2328} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2328}{Verify regeneration of un-archived Data Products (Services)\_1} &  Draft \tabularnewline
    \hyperref[lvv-t2329]{LVV-T2329} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2329}{Verify the archiving of ancilliary data} &  Draft \tabularnewline
    \hyperref[lvv-t2330]{LVV-T2330} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2330}{Verify that the data processing infrastructure for user computing exists} &  Draft \tabularnewline
    \hyperref[lvv-t2331]{LVV-T2331} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2331}{Verify the number of precovery serivce connections} &  Draft \tabularnewline
    \hyperref[lvv-t2332]{LVV-T2332} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2332}{Verify the time to retrieve results from a query of the prompt products
database} &  Draft \tabularnewline
    \hyperref[lvv-t2333]{LVV-T2333} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2333}{Verify the minimum number of simultaneous users querying the prompt
products database.} &  Draft \tabularnewline
    \hyperref[lvv-t2334]{LVV-T2334} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2334}{Verify implementation of processed visit images - snaps} &  Draft \tabularnewline
    \hyperref[lvv-t2692]{LVV-T2692} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2692}{Verify implementation of Image Metadata Access} &  Draft \tabularnewline
    \hyperref[lvv-t2693]{LVV-T2693} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2693}{Verify implementation of Image Provenance Access} &  Draft \tabularnewline
    \hyperref[lvv-t2694]{LVV-T2694} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2694}{Verify implementation of File Data Product Access} &  Draft \tabularnewline
    \hyperref[lvv-t2695]{LVV-T2695} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2695}{Verify implementation of file metadata access} &  Draft \tabularnewline
    \hyperref[lvv-t2696]{LVV-T2696} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2696}{Verify implementation of file provenance access} &  Draft \tabularnewline
    \hyperref[lvv-t2697]{LVV-T2697} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2697}{Verify implementation of Catalog Data Product Access} &  Draft \tabularnewline
    \hyperref[lvv-t2698]{LVV-T2698} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2698}{Verify implementation of Catalog Metadata Access} &  Draft \tabularnewline
    \hyperref[lvv-t2699]{LVV-T2699} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2699}{Verify implementation of Catalog Provenance Access} &  Draft \tabularnewline
    \hyperref[lvv-t2700]{LVV-T2700} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2700}{Verify Result latency for high-volume complex queries} &  Draft \tabularnewline
    \hyperref[lvv-t2724]{LVV-T2724} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2724}{Verify Result latency for high-volume full-sky queries on the Object
table} &  Draft \tabularnewline
\bottomrule
\end{longtable}
...
‚Äã\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T32}{LVV-T32}‚Äã‚Äã‚Äã
...
\subsubsection{LVV-T136 - Verify implementation of Image Data Product Access}\label{lvv-t136}
...
\paragraph{Predecessors}\mbox{}\\
\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T140}{LVV-T140}‚Äã‚Äã‚Äã‚Äã
...
testing.\\[2\baselineskip]This should be verified for simulated stars
and fake galaxies. Furthermore, verification should include the
following:\\
...
\item
  ...
  recovered to within \textasciitilde{}10\% of their true values,
\item
...
\paragraph{Predecessors}\mbox{}\\
‚Äã\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T216}{LVV-T216}‚Äã‚Äã‚Äã\\
‚Äã\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T217}{LVV-T217}‚Äã‚Äã‚Äã
...
\\\midrule
1 & Approved & Normal &
Demonstration & Michelle Butler [X]
\\\bottomrule
...
separations greater than or equal to 5 arcmin}\label{lvv-t1754}
...
\subsubsection{LVV-T1758 - Verify that the repeatability outlier limit for isolated bright
non-saturated point sources in the u, z, and y filters (PA2uzy) can be
applied.}\label{lvv-t1758}
...
\subsubsection{LVV-T1759 - Verify that the repeatability outlier limit for isolated bright
non-saturated point sources in the g, r, and i filters (PA2gri) can be
applied.}\label{lvv-t1759}
...
\subsubsection{LVV-T2202 - Verify that the of zero-point error outlier limit threshold (PA4) can be
applied.}\label{lvv-t2202}
...
Test & Leanne Guy
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2202}{LVV-T2202} in Jira } \\
\end{longtable}
...
section §4.3.2) and each of the expected units (PVIs, coadds, etc),
...
elements
(‚Äã\href{https://jira.lsstcorp.org/browse/LVV-104}{LVV-104)}‚Äã‚Äã‚Äã.
...
\end{tabular}
{\scriptsize
вЂ‹вЂ‹вЂ‹вЂ‹Load data into DRP database
...
\end{tabular}
{\scriptsize
Create a test user account for the Rubin Science Platform.
...
\end{tabular}
{\scriptsize
Set the RSP resource allocations for the test user to very low values.
...
\end{tabular}
{\scriptsize
Check that disruptions do not exceed the productionMaxDowntime (24
hours)
...
\end{tabular}
{\scriptsize
Load Prompt and DR catalogs into PDAC, observe access via Rubin Science
Platform
...
federation with other catalogs via Rubin Science Platform (RSP)
...
\subsubsection{LVV-T2091 - Verify Fraction of Alerts Transmitted Within Latency Threshold}\label{lvv-t2091}
...
Test & Eric Bellm
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2091}{LVV-T2091} in Jira } \\
\end{longtable}
...
\subsubsection{LVV-T2092 - Verify Meeting Threshold for Max Fraction of Visits With Failed Alerts}\label{lvv-t2092}
...
Test & Eric Bellm
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2092}{LVV-T2092} in Jira } \\
\end{longtable}
...
Verify that no more than \textbf{sciVisitAlertFailure =
0.1{[}percent{]}} of visits fail to generate or distribute alerts.
...
\subsubsection{LVV-T2093 - Verify Latency of Reporting Transients}\label{lvv-t2093}
...
Test & Eric Bellm
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2093}{LVV-T2093} in Jira } \\
\end{longtable}
...
Verify that transients are reported within \textbf{OTT1 =
1{[}minute{]}~}following the completion of readout of the last image of
a visit. At least \textbf{OTR1 = 98{[}percent{]}~}of the alerts should
be transmitted within this latency period.
...
\subsubsection{LVV-T2094 - Verify Peak Number of Alerts Per Standard Visit}\label{lvv-t2094}
...
Test & Eric Bellm
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2094}{LVV-T2094} in Jira } \\
\end{longtable}
...
Verify that the instantaneous peak number of alerts per standard visit
does not exceed~\textbf{nAlertVisitPeak = 40000{[}integer{]}}.
...
\subsubsection{LVV-T2095 - Verify Max Fraction of Visits With Alert Delays}\label{lvv-t2095}
...
Test & Eric Bellm
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2095}{LVV-T2095} in Jira } \\
\end{longtable}
...
Verify that no more than \textbf{sciVisitAlertDelay = 1{[}percent{]}} of
science visits have less than \textbf{OTR1 = 98{[}percent{]}} of the
alerts distributed within \textbf{OTT1 = 1{[}minute{]}}.
...
\subsubsection{LVV-T2096 - Verify Handling of Peak Number of Alerts}\label{lvv-t2096}
...
Test & Eric Bellm
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2096}{LVV-T2096} in Jira } \\
\end{longtable}
...
Verify that the system can identify and distribute at least
\textbf{nAlertVisitPeak}~\textbf{=} \textbf{40000{[}integer{]}~}alerts
per standard visit.
...
\subsubsection{LVV-T2097 - Verify Handling of Average Number of Alerts}\label{lvv-t2097}
...
Test & Eric Bellm
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2097}{LVV-T2097} in Jira } \\
\end{longtable}
...
\subsubsection{LVV-T2176 - Per-image limit on the median residual ellipticity correlations at
scales greater than or equal to 5 arcmin.}\label{lvv-t2176}
...
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2176}{LVV-T2176} in Jira } \\
\end{longtable}
...
\subsubsection{LVV-T2177 - Per-image limit on the median residual ellipticity correlations at
scales less than to 5 arcmin.}\label{lvv-t2177}
...
Inspection & Leanne Guy
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2177}{LVV-T2177} in Jira } \\
\end{longtable}
...
\subsubsection{LVV-T2297 - Verify implementation of Science Data Archive}\label{lvv-t2297}
...
Demonstration & Leanne Guy
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2297}{LVV-T2297} in Jira } \\
\end{longtable}
...
\subsubsection{LVV-T2302 - Verify the minimum number of simultaneous users retrieving a set of
postage stamp images}\label{lvv-t2302}
...
Test & Leanne Guy
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2302}{LVV-T2302} in Jira } \\
\end{longtable}
...
Verify that the DMS can support at least postageStampRetrievalUsers = 10
simuylataneous users retrieving a set of postage stamp images in
postageStampRetrievalTime = 10sec.~
...
\end{tabular}
{\scriptsize
Execute ten independent processes simultaneously to retrieve a set of
postage stamp images. Time the execution ~until all complete
...
\end{tabular}
{\scriptsize
Verify that the time to execute all processes is within specification~
...
\subsubsection{LVV-T2303 - Verify Image Archive}\label{lvv-t2303}
...
Test & Leanne Guy
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2303}{LVV-T2303} in Jira } \\
\end{longtable}
...
\subsubsection{LVV-T2304 - Verify maximum number of stars associated with a DIASource.}\label{lvv-t2304}
...
Test & Leanne Guy
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2304}{LVV-T2304} in Jira } \\
\end{longtable}
...
\end{tabular}
{\scriptsize
Verify that DIAObjects have no more than diaNearbyObjMaxStar that point
...
\subsubsection{LVV-T2305 - Verify radius considered nearby}\label{lvv-t2305}
...
Test & Leanne Guy
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2305}{LVV-T2305} in Jira } \\
\end{longtable}
...
\end{tabular}
{\scriptsize
Verify that all stars adn galaxies associated with DIAObjects are within
dianNearbyObjRadius.~
...
\subsubsection{LVV-T2328 - Verify regeneration of un-archived Data Products (Services)\_1}\label{lvv-t2328}
...
Test & Leanne Guy
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2328}{LVV-T2328} in Jira } \\
\end{longtable}
...
\subsubsection{LVV-T2329 - Verify the archiving of ancilliary data}\label{lvv-t2329}
...
Test & Leanne Guy
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2329}{LVV-T2329} in Jira } \\
\end{longtable}
...
\subsubsection{LVV-T2330 - Verify that the data processing infrastructure for user computing exists}\label{lvv-t2330}
...
Test & Leanne Guy
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2330}{LVV-T2330} in Jira } \\
\end{longtable}
...
\subsubsection{LVV-T2331 - Verify the number of precovery serivce connections}\label{lvv-t2331}
...
Test & Leanne Guy
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2331}{LVV-T2331} in Jira } \\
\end{longtable}
...
\subsubsection{LVV-T2332 - Verify the time to retrieve results from a query of the prompt products
database}\label{lvv-t2332}
...
Test & Leanne Guy
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2332}{LVV-T2332} in Jira } \\
\end{longtable}
...
\subsubsection{LVV-T2333 - Verify the minimum number of simultaneous users querying the prompt
products database.}\label{lvv-t2333}
...
Test & Leanne Guy
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2333}{LVV-T2333} in Jira } \\
\end{longtable}
...
\subsubsection{LVV-T2334 - Verify implementation of processed visit images - snaps}\label{lvv-t2334}
...
Test & Leanne Guy
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2334}{LVV-T2334} in Jira } \\
\end{longtable}
...
visit.\\[2\baselineskip]The verification should include confirming that
the images have been trimmed of the overscan, and that correction of the
instrumental signature (including crosstalk) has been applied
properly.\\[2\baselineskip]This test specifically tests the combination
of snaps.~
...
\subsubsection{LVV-T2692 - Verify implementation of Image Metadata Access}\label{lvv-t2692}
...
Test & Jeffrey Carlin
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2692}{LVV-T2692} in Jira } \\
\end{longtable}
...
\subsubsection{LVV-T2693 - Verify implementation of Image Provenance Access}\label{lvv-t2693}
...
Test & Jeffrey Carlin
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2693}{LVV-T2693} in Jira } \\
\end{longtable}
...
\subsubsection{LVV-T2694 - Verify implementation of File Data Product Access}\label{lvv-t2694}
...
Test & Jeffrey Carlin
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2694}{LVV-T2694} in Jira } \\
\end{longtable}
...
\subsubsection{LVV-T2695 - Verify implementation of file metadata access}\label{lvv-t2695}
...
Test & Jeffrey Carlin
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2695}{LVV-T2695} in Jira } \\
\end{longtable}
...
\subsubsection{LVV-T2696 - Verify implementation of file provenance access}\label{lvv-t2696}
...
Test & Jeffrey Carlin
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2696}{LVV-T2696} in Jira } \\
\end{longtable}
...
Verify that available file data products' provenance can be listed and
retrieved.
...
\subsubsection{LVV-T2697 - Verify implementation of Catalog Data Product Access}\label{lvv-t2697}
...
Test & Jeffrey Carlin
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2697}{LVV-T2697} in Jira } \\
\end{longtable}
...
\subsubsection{LVV-T2698 - Verify implementation of Catalog Metadata Access}\label{lvv-t2698}
...
Test & Jeffrey Carlin
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2698}{LVV-T2698} in Jira } \\
\end{longtable}
...
\subsubsection{LVV-T2699 - Verify implementation of Catalog Provenance Access}\label{lvv-t2699}
...
Test & Jeffrey Carlin
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2699}{LVV-T2699} in Jira } \\
\end{longtable}
...
\subsubsection{LVV-T2700 - Verify Result latency for high-volume complex queries}\label{lvv-t2700}
...
\\\midrule
1 & Draft & Normal &
Demonstration & Colin Slater
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2700}{LVV-T2700} in Jira } \\
\end{longtable}
...
\subsubsection{LVV-T2724 - Verify Result latency for high-volume full-sky queries on the Object
table}\label{lvv-t2724}
...
Test & Colin Slater
\\\bottomrule
\multicolumn{6}{c}{ Open \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T2724}{LVV-T2724} in Jira } \\
\end{longtable}
...
Verify latency against a full scale, e.g DR1 sized Object
catalog\\[2\baselineskip]
...
\subsection{LVV-T849 - Authenticate to the Portal Aspect of the RSP}\label{lvv-t849}
...
\paragraph{Test Items}\mbox{}\\
Obtain an authenticated session in the Portal Aspect of the Rubin
Science Platform
...
\subsection{LVV-T850 - Log out of the portal aspect of the RSP}\label{lvv-t850}
...
\paragraph{Test Items}\mbox{}\\
Leave the portal aspect of the Rubin Science Platform in a clean state
...
\subsection{LVV-T1208 - Log out of the notebook aspect of the RSP}\label{lvv-t1208}
...
\paragraph{Test Items}\mbox{}\\
Leave the notebook aspect of the Rubin Science Platform in a clean state
...
\subsection{LVV-T1744 - Run faro on a repository of data}\label{lvv-t1744}
...
\paragraph{Test Items}\mbox{}\\
Run the faro code on a dataset containing the appropriate data products,
to evaluate the metrics that have been implemented in faro.
