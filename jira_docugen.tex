...
obtain RA, Dec coordinates.\\[2\baselineskip]We will assume that Gaia
provides a source of ``truth.'' Match the source list to Gaia DR2, and
calculate the positional offset between the test data and the Gaia
catalog.~
...
\subsubsection{Test Procedure}
    ...
    \endhead
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 2 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Execute the AP pipeline (`ap\_pipe`).
...
\subsubsection{Test Procedure}
    ...
    \endhead
            ...
            \multirow{3}{*}{ 1 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Confirm that the CI jobs known as ``ci\_hsc'' (DRP processing on HSC
data) and ``ap\_verify'' (Alert Production processing on a small amount
of HiTS 2015 DECam data) successfully run.~
...
commands into the EFD.~
        ...
        \\ \midrule
            ...
            \multirow{3}{*}{ 2 } & Description &
            \begin{minipage}[t]{13cm}{\footnotesize
            Show that the data products are present in the archived EFD within
L1PublicT hours.
