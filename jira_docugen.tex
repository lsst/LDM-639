...
processing
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T376}{Verify the Calculation of Ellipticity Residuals and Correlations
} \tabularnewline
...
CCD-sized coadd cutouts
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1168}{Verify Summit - Base Network Integration
} \tabularnewline
...
users
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1264}{Verify implementation of archiving camera test data
} \tabularnewline
    \hyperref[lvv-t1276]{LVV-T1276} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1276}{Verify implementation of latency of reporting optical transients
} \tabularnewline
    \hyperref[lvv-t1277]{LVV-T1277} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1277}{Verify processing of maximum number of calibration exposures
} \tabularnewline
...
cutouts
    ...
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1524}{Verify Implementation of Exporting MOCs as FITS
} \tabularnewline
    \hyperref[lvv-t1525]{LVV-T1525} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1525}{Verify Implementation of Linkage Between HiPS Maps and Coadded Images
} \tabularnewline
    \hyperref[lvv-t1526]{LVV-T1526} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1526}{Verify Availability of Secure and Authenticated HiPS Service
} \tabularnewline
    \hyperref[lvv-t1527]{LVV-T1527} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1527}{Verify Support for HiPS Visualization
} \tabularnewline
    \hyperref[lvv-t1528]{LVV-T1528} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1528}{Verify Visualization of MOCs via Science Platform
} \tabularnewline
    \hyperref[lvv-t1529]{LVV-T1529} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1529}{Verify Production of All-Sky HiPS Map
} \tabularnewline
    \hyperref[lvv-t1530]{LVV-T1530} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1530}{Verify Production of Multi-Order Coverage Maps for Survey Data
} \tabularnewline
    \hyperref[lvv-t1560]{LVV-T1560} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1560}{Verify archiving of processing provenance
} \tabularnewline
    \hyperref[lvv-t1561]{LVV-T1561} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1561}{Verify provenance availability to science users
} \tabularnewline
    \hyperref[lvv-t1562]{LVV-T1562} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1562}{Verify availability of re-run tools
} \tabularnewline
    \hyperref[lvv-t1563]{LVV-T1563} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1563}{Verify re-run on different system produces the same results
} \tabularnewline
    \hyperref[lvv-t1564]{LVV-T1564} &
    \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1564}{Verify re-run on similar system produces the same results
} \tabularnewline
\bottomrule
\end{longtable}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T376}{LVV-T376}
    - Verify the Calculation of Ellipticity Residuals and Correlations
}\label{lvv-t376}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T385}{LVV-T385}
    - Verify implementation of minimum number of simultaneous retrievals of
CCD-sized coadd cutouts
}\label{lvv-t385}
...
\item
  AuxTel hardware and control systems are functional with LATIS. AuxTel
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1168}{LVV-T1168}
    - Verify Summit - Base Network Integration
}\label{lvv-t1168}
...
\item
  ...
  20171218
  \href{https://docushare.lsst.org/docushare/dsweb/Get/\citeds{DMTR-82}/\citeds{DMTR-82}.pdf}{\citeds{DMTR-82}})
\item
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1264}{LVV-T1264}
    - Verify implementation of archiving camera test data
}\label{lvv-t1264}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1276}{LVV-T1276}
    - Verify implementation of latency of reporting optical transients
}\label{lvv-t1276}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1277}{LVV-T1277}
    - Verify processing of maximum number of calibration exposures
}\label{lvv-t1277}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1332}{LVV-T1332}
    - Verify implementation of maximum time for retrieval of CCD-sized coadd
cutouts
}\label{lvv-t1332}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1524}{LVV-T1524}
    - Verify Implementation of Exporting MOCs as FITS
}\label{lvv-t1524}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1525}{LVV-T1525}
    - Verify Implementation of Linkage Between HiPS Maps and Coadded Images
}\label{lvv-t1525}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1526}{LVV-T1526}
    - Verify Availability of Secure and Authenticated HiPS Service
}\label{lvv-t1526}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1527}{LVV-T1527}
    - Verify Support for HiPS Visualization
}\label{lvv-t1527}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1528}{LVV-T1528}
    - Verify Visualization of MOCs via Science Platform
}\label{lvv-t1528}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1529}{LVV-T1529}
    - Verify Production of All-Sky HiPS Map
}\label{lvv-t1529}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1530}{LVV-T1530}
    - Verify Production of Multi-Order Coverage Maps for Survey Data
}\label{lvv-t1530}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1560}{LVV-T1560}
    - Verify archiving of processing provenance
}\label{lvv-t1560}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1561}{LVV-T1561}
    - Verify provenance availability to science users
}\label{lvv-t1561}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1562}{LVV-T1562}
    - Verify availability of re-run tools
}\label{lvv-t1562}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1563}{LVV-T1563}
    - Verify re-run on different system produces the same results
}\label{lvv-t1563}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1564}{LVV-T1564}
    - Verify re-run on similar system produces the same results
}\label{lvv-t1564}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1060}{LVV-T1060}
    - Run Periodic Calibration Products Production Payload
}\label{lvv-t1060}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T866}{LVV-T866}
    - Run Alert Production Payload
}\label{lvv-t866}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1059}{LVV-T1059}
    - Run Daily Calibration Products Update Payload
}\label{lvv-t1059}
...
\subsection{\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T1064}{LVV-T1064}
    - Run Data Release Production Payload
}\label{lvv-t1064}
